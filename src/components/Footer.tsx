      ...
      <div className="flex flex-col gap-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex flex-col gap-6">
            <p className="font-solway-medium text-xl text-white">
              Terms &amp; Condition
            </p>
        ...
        <div className="flex items-start justify-start gap-20">
          <div className="flex flex-col gap-6">
            <Link to={'#'} className="font-solway-medium text-xl text-white">
              Follow us
            </Link>
          ...
          <Link to={'/login'} className="font-solway-medium text-xl text-white">
            Log in
          </Link>
        </div>
      </div>
